...
import { requirePremiumSubscription, attachSubscriptionStatus, checkExpiringSubscription } from '../middleware/subscription-middleware.js';
 ...
 */
router.post('/cancel', requirePremiumSubscription, async (req, res) => {
    try {
        const userId = req.user.userId;
 ...
 */
router.get('/check-expiry', attachSubscriptionStatus, checkExpiringSubscription, async (req, res) => {
    try {
        const userId = req.user.userId;
 ...
 */
router.post('/manual-renewal-check', async (req, res) => {
    try {
        // TODO: Add admin authentication middleware
