...
export const checkSubscriptionLimits = (limits: {
  freemium: { requestsPerHour?: number; requestsPerDay?: number };
 ...
 */
export const checkExpiringSubscription = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
 ...
 */
export const hasPremiumAccess = (req: Request): boolean => {
 ...
 */
export const getSubscriptionTier = (req: Request): 'freemium' | 'premium' => {
 ...
 */
export const isSubscriptionExpiringSoon = (req: Request): boolean => {
