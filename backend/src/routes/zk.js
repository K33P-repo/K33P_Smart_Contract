...
const { hashPhone, hashBiometric, hashPasskey, combinedHash } = require('../utils/hash');
const { poseidonHash, generateZkCommitment, generateZkProof, verifyZkProof } = require('../utils/zk');
