...
import { EnhancedK33PManager, BlockchainVerifier } from './enhanced-k33p-manager'; //adjust this part and copy the same code in k33p-sign-interaction in the smartcontract folder to a new folder
